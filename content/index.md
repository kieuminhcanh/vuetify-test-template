        ...
        ::v-card-text{class="pa-8"}
          ...
          ::v-row{align="center"}
            ...
            ::v-col{cols="12" md="9"}
              ...
              ::
              ```
              Passionate developer with 17+ years of experience in building modern web applications.
              ```
            ::
          ::
        ::
        ...
        ::v-card-text
          ...
          ::v-row{align="center" class="mb-2"}
            ...
            ::v-col{cols="8"}
              ...
              ::v-progress-linear{modelValue="100" color="success" height="8"}
              ::
            ::
          ::
          ...
          ::v-row{align="center" class="mb-2"}
            ...
            ::v-col{cols="8"}
              ...
              ::v-progress-linear{modelValue="75" color="info" height="8"}
              ::
            ::
          ::
          ...
          ::v-row{align="center" class="mb-2"}
            ...
            ::v-col{cols="8"}
              ...
              ::v-progress-linear{modelValue="50" color="warning" height="8"}
              ::
            ::
          ::
        ::
      ...
      ::v-card{title="Projects" variant="outlined" class="mt-4"}
        ...
        ::v-row
          ...
          ::v-col{cols="12" sm="6"}
            ...
            ::v-card{title="E-Commerce Platform" text="A modern e-commerce solution built with Nuxt 3, Vuetify, and Stripe integration." variant="outlined"}



              ::v-img{src="https://placehold.co/300x200" aspect-ratio="1.5"}
              ::
          ...
          ::v-col{cols="12" sm="6"}
            ...
            ::v-card{title="Task Management App" text="A collaborative task management tool with real-time updates using Socket.io." variant="outlined"}
          ...
          ::v-col{cols="12" sm="6"}
            ...
            ::v-card{title="Portfolio Website" text="A creative portfolio website showcasing design and development work." variant="outlined"}
          ...
          ::v-col{cols="12" sm="6"}
            ...
            ::v-card{title="Weather Dashboard" text="A weather forecast application with interactive maps and detailed analytics." variant="outlined"}
